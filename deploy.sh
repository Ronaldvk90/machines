...
ssh root@"$HOST" 'install -m 600 /dev/stdin /mnt/var/lib/agenix/agenix.key'
ssh root@"$HOST" "cd /mnt && nixos-enter && nixos-rebuild switch --flake github:ronaldvk90/machines#$MACHINE"